...
Future<String> requestDownload({BuildContext context, DownloadedBook downloadTask, bool isSample}) async {
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                  isSuccess ? "Your payment is apporved" : "Your payment is declined",
                  style: boldTextStyle(
