...
class DownloadedBook {
  ...
  DownloadedBook({this.id, this.taskId, this.bookId, this.bookName, this.frontCover, this.fileType});
...
DownloadedBook defaultBook(BookDetail mBookDetail, fileType) {
  return DownloadedBook(bookId: mBookDetail.bookId.toString(), bookName: mBookDetail.name, frontCover: mBookDetail.frontCover, fileType: fileType);
}
