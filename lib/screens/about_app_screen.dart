...
class _AboutAppState extends State<AboutApp> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget("About Us", elevation: 0, color: context.scaffoldBackgroundColor, textColor: context.theme.textTheme.headline6.color),
      body: Stack(
        children: <Widget>[
          Container(
                    ...
                    if (snap.hasData) {
                      return Column(
                        children: [
                          ...
                          6.height,
                          Text('Version ${snap.data.version.validate()}', style: primaryTextStyle(color: context.theme.textTheme.headline6.color)),
                        ],
                      );
                    }
                    return SizedBox();
