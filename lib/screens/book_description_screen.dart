...
class _BookDescriptionScreenState extends State<BookDescriptionScreen> {
  ...
  void initState() {
    super.initState();
    2.seconds.delay.then((value) => setStatusBarColor(Theme.of(context).cardTheme.color, statusBarBrightness: Brightness.light));
                  ...
                  SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                10.height,
                                Text("By ${mBookDetail.authorName}", style: secondaryTextStyle(color: context.theme.textTheme.subtitle2.color)),
                                10.height,
                                Container(
                        ...
                        16.height,
                        Text('Introduction', style: boldTextStyle(size: 22, color: context.theme.textTheme.headline6.color)).paddingSymmetric(horizontal: 16),
                        ...
                        16.height,
                      //  if (_bannerAd != null) Container(child: AdWidget(ad: _bannerAd), height: _bannerAd.size.height.toDouble()),
                        16.height,
                        reviewWidget(snap),
                        Row(
                          children: [
    ...
    return Scaffold(
      appBar: appBarWidget(
        ...
        actions: [
          ...
          IconButton(
              icon: SvgPicture.asset(mBookDetail.isWishList.toString().toInt().validate(value: 0) == 0 ? icon_bookmark : icon_bookmark_fill, color: context.theme.iconTheme.color),
              onPressed: () {
                if (getBoolAsync(IS_LOGGED_IN)) {
                  setState(() {
